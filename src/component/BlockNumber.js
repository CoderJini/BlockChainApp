...
class BlockNumber extends Component {
  ...
  getBlockNumber = async () => {
    // debugger;
    const blockNumber = await caver.klay.getBlockNumber().then(function(i){
        this.setState({ currentBlockNumber: i })
    }.bind(this));
  ...
  render() {
    ...
    return (
        ...
        // {/* //</form>/className="navbar-text BlockNumber justify-content-end"> */}
        //     Block No. {currentBlockNumber}
        // {/* // </span> */}
        // </form>
    ...
    //     <p className="BlockNumber__current"></p>
    //   </div>
    )
  }
}
